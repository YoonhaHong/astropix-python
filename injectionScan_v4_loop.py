    ...
    for r in range(args.rowrange[0],args.rowrange[1]+1,1):
        for c in range(args.colrange[0],args.colrange[1]+1,1):
            ...
            for i in injs:
                ...
                #if r==args.rowrange[0] and c==args.colrange[0] and i==args.injectRange[0]:#first injection - connect to FPGA but leave open
                #    main(args, r, c, float(i), fpgaDiscon=False)
                #elif r==args.rowrange[1] and c==args.colrange[1] and i==args.injectRange[1]: #final injection - disconnect from FPGA upon completion
